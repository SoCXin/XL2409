...
#define __MPU_PRESENT             0 /*!< sip_mcu do not provide MPU                  */
#define __VTOR_PRESENT            1 /*!< Vector  Table  Register supported             */
#define __NVIC_PRIO_BITS          2 /*!< sip_mcu uses 2 Bits for the Priority Levels */
...
/**
 * @brief sip_mcu Interrupt Number Definition, according to the selected device
...
typedef enum
{
  ...
  /******  sip_mcuspecific Interrupt Numbers *********************************************************************/
...
#include "system_sip_mcu.h"            /* sip_mcu System Header */
#include <stdint.h>
