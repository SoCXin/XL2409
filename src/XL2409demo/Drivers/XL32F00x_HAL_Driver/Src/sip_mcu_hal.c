...
/** @defgroup HAL_Private_Constants HAL Private Constants
  ...
  */
/**
 * @brief sip_mcu HAL Driver version number
   */
#define __SIP_MCU_HAL_VERSION_MAIN   (0x01U) /*!< [31:24] main version */
#define __SIP_MCU_HAL_VERSION_SUB1   (0x03U) /*!< [23:16] sub1 version */
#define __SIP_MCU_HAL_VERSION_SUB2   (0x00U) /*!< [15:8]  sub2 version */
#define __SIP_MCU_HAL_VERSION_RC     (0x00U) /*!< [7:0]  release candidate */
#define __SIP_MCU_HAL_VERSION        ((__sip_mcu_HAL_VERSION_MAIN << 24U)\
                                       |(__sip_mcu_HAL_VERSION_SUB1 << 16U)\
                                       |(__sip_mcu_HAL_VERSION_SUB2 << 8U )\
                                       |(__sip_mcu_HAL_VERSION_RC))
...
{
  return __SIP_MCU_DEVICE_VERSION;
}
