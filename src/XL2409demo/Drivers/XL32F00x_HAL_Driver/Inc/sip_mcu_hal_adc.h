#ifndef __SIP_MCU_HAL_ADC_H
#define __SIP_MCU_HAL_ADC_H
...
typedef struct
{
  ...
  uint32_t ScanConvMode;          /*!< Configures the sequencer of regular group.
                                       ...
                                       Sequencer is automatically enabled if several channels are set (sequencer cannot be disabled, as it can be the case on other sip_mcu devices):
  ...
  uint32_t SamplingTimeCommon;    /*!< Sampling time value to be set for the selected channel.
                                       ...
                                       Note: On sip_mcudevices, the sampling time setting is common to all channels. On some other sip_mcu devices, this parameter in channel wise and is located into ADC channel initialization structure.
...
typedef struct
{
  ...
  uint32_t Rank;                   /*!< Add or remove the channel from ADC regular group sequencer.
                                        On sip_mcudevices,  number of ranks in the sequence is defined by number of channels enabled, rank of each channel is defined by channel number (channel 0 fixed on rank 0, channel 1 fixed on rank1, ...)..
...
#define HAL_ADC_STATE_REG_EOSMP         (0x00000800U)    /*!< Not available on sip_mcudevice: End Of Sampling flag raised  */

/* States of ADC group injected */
#define HAL_ADC_STATE_INJ_BUSY          (0x00001000U)    /*!< Not available on sip_mcudevice: A conversion on group injected is ongoing or can occur (either by auto-injection mode,
                                                                       external trigger, low power auto power-on, multimode ADC master control) */
#define HAL_ADC_STATE_INJ_EOC           (0x00002000U)    /*!< Not available on sip_mcudevice: Conversion data available on group injected */
#define HAL_ADC_STATE_INJ_JQOVF         (0x00004000U)    /*!< Not available on sip_mcudevice: Not available on sip_mcudevice: Injected queue overflow occurrence */

/* States of ADC analog watchdogs */
#define HAL_ADC_STATE_AWD1              (0x00010000U)    /*!< Out-of-window occurrence of analog watchdog 1 */
#define HAL_ADC_STATE_AWD2              (0x00020000U)    /*!< Not available on sip_mcudevice: Out-of-window occurrence of analog watchdog 2 */
#define HAL_ADC_STATE_AWD3              (0x00040000U)    /*!< Not available on sip_mcudevice: Out-of-window occurrence of analog watchdog 3 */

/* States of ADC multi-mode */
#define HAL_ADC_STATE_MULTIMODE_SLAVE   (0x00100000U)    /*!< Not available on sip_mcudevice: ADC in multimode slave state, controlled by another ADC master ( */
...
/** @defgroup ADC_Scan_mode ADC Scan mode
  * @{
  */
/* Note: Scan mode values must be compatible with other sip_mcu devices having  */
/*       a configurable sequencer.                                            */
/*       Scan direction setting values are defined by taking in account       */
/*       already defined values for other sip_mcu devices:                      */
...
/*       In case of migration from another sip_mcu device, the user will be     */
...
#define ADC_SCAN_ENABLE         ADC_SCAN_DIRECTION_FORWARD       /* For compatibility with other sip_mcu devices */
