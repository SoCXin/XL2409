...
================================================================================
  ...
  [..]
      The XL32F0xx device family integrates two analog comparators instances:
      COMP1, COMP2.
...
================================================================================
  [..]
      ...
      -@@- HAL_COMP_Init() calls internally __HAL_RCC_SYSCFG_CLK_ENABLE()
          ...
          However, this is a legacy strategy. In future XL32 families,
