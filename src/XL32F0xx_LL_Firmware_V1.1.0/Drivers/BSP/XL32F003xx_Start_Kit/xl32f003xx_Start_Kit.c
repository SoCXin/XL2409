...
/* Includes ------------------------------------------------------------------*/
#include "xl32f003xx_Start_Kit.h"

/**
  * @brief XL32F003xx STK BSP Driver version number
  */
#define __XL32F003xx_STK_BSP_VERSION_MAIN   (0x01U) /*!< [31:24] main version */
#define __XL32F003xx_STK_BSP_VERSION_SUB1   (0x00U) /*!< [23:16] sub1 version */
#define __XL32F003xx_STK_BSP_VERSION_SUB2   (0x00U) /*!< [15:8]  sub2 version */
#define __XL32F003xx_STK_BSP_VERSION_RC     (0x00U) /*!< [7:0]  release candidate */
#define __XL32F003xx_STK_BSP_VERSION        ((__XL32F003xx_STK_BSP_VERSION_MAIN << 24) \
                                            |(__XL32F003xx_STK_BSP_VERSION_SUB1 << 16) \
                                            |(__XL32F003xx_STK_BSP_VERSION_SUB2 << 8 ) \
                                            |(__XL32F003xx_STK_BSP_VERSION_RC))
...
/** @addtogroup XL32F003xx_STK_Exported_Functions
  * @{
  */
...
{
  return __XL32F003xx_STK_BSP_VERSION;
}
